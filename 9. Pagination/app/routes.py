...
@login_required # Protect function from anon. users
def index():
...
def explore():
    ...
    # Our render_template function will reuse the index page
    # without the form to write blog posts, so we remove it
    # by calling the index.html w/o the form argument
